...
@NgModule({
  ...
  exports: [HeaderComponent, FooterComponent, ErrorComponent, PaginationComponent, ProductCardComponent, ShopCardComponent, CategoryCardComponent, ShortNumberPipe, DateOnlyPipe, PhoneNumberPipe],
