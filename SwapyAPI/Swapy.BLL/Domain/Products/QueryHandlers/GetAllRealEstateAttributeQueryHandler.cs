...
{
    public class GetAllRealEstateAttributeQueryHandler : IRequestHandler<GetAllRealEstateAttributeQuery, ProductResponseDTO<RealEstateAttribute>>
    {
        ...
        public async Task<ProductResponseDTO<RealEstateAttribute>> Handle(GetAllRealEstateAttributeQuery request, CancellationToken cancellationToken)
        {
